...
class eshop_setting_merchant extends eshop_metabox_class {
	function on_load_page() {
		...
		add_meta_box('eshop-m-twocheckout', __('2Checkout','eshop'), array(&$this, 'twocheckout_box'), $this->pagehook, 'normal', 'core');
	...
	function twocheckout_box($eshopoptions) {
	?>
		<fieldset>
			<?php 		
			$this->show_img('twocheckout');
			?>
			<p class="cbox"><input id="eshop_method" name="eshop_method[]" type="checkbox" value="twocheckout"<?php if(in_array('twocheckout',(array)$eshopoptions['method'])) echo ' checked="checked"'; ?> /><label for="eshop_method" class="eshopmethod"><?php _e('Accept payment by 2Checkout','eshop'); ?></label></p>
			<label for="eshop_twocheckout_sid"><?php _e('2Checkout Seller ID (Account Number)','eshop'); ?></label><input id="eshop_twocheckout_sid" name="eshop_twocheckout_sid" type="text" value="<?php echo $eshopoptions['twocheckout_sid']; ?>" size="30" /><br />
			<label for="eshop_twocheckout_secret"><?php _e('2Checkout Secret Word','eshop'); ?></label><input id="eshop_twocheckout_secret" name="eshop_twocheckout_secret" type="text" value="<?php echo $eshopoptions['twocheckout_secret']; ?>" size="30" /><br />
		</fieldset>
		<?php
	}
	...
	function on_save_changes() {
		...
		//these are for 2checkout
		$eshopoptions['twocheckout_sid']=$wpdb->escape(trim($_POST['eshop_twocheckout_sid']));
		$eshopoptions['twocheckout_secret']=$wpdb->escape(trim($_POST['eshop_twocheckout_secret']));
